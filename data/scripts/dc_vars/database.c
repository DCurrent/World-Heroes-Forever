...
// Package Files
#include    "data/scripts/dc_datbase/settings.h"

// Clear an global scope variable.
int dc_vars_clear_global_var(void key)
{
    ...
    {
        dc_error_set_function("dc_vars_clear_global_var(void key)");
    ...
    setglobalvar(key, NULL());

    return DC_VARS_FLAG_TRUE;
}

// Get an global scope float.
float dc_vars_get_global_float(void key)
{
    ...
    if(is_key == DC_VARS_FLAG_FALSE)
    {
        dc_error_set_function("dc_vars_get_global_float(void key)");
        dc_error_set_message("{key} must be a valid integer, pointer, or string.");
        dc_error_set_argument(key);
        dc_error_alert();
...
// Set an global scope float.
int dc_vars_set_global_float(void key, float value)
{
    int is_key;     // Valid key flag.
    int is_float;   // Valid type flag.

    // Set function name for possible error trapping.
    dc_error_set_function("dc_vars_set_global_float(void key, float value)");
...
// Get an global scope integer.
int dc_vars_get_global_int(void key)
{
    ...
    // Set function name for possible error trapping.
    dc_error_set_function("dc_vars_get_global_int(void key)");
...
// Set an global scope integer.
int dc_vars_set_global_int(void key, int value)
{
    int is_key; // Valid key flag.
    int is_int; // Valid type flag.

    // Set function name for possible error trapping.
    dc_error_set_function("dc_vars_set_global_int(void key, int value)");
...
// Get an global scope pointer.
void dc_vars_get_global_pointer(void key)
{
    ...
    // Set function name for possible error trapping.
    dc_error_set_function("dc_vars_get_global_pointer(void key)");
...
// Set an global scope pointer.
int dc_vars_set_global_pointer(void key, int value)
{
    int is_key;     // Valid key flag.
    int is_pointer; // Valid type flag.

    // Set function name for possible error trapping.
    dc_error_set_function("dc_vars_set_global_pointer(void key, void pointer)");
...
// Get an global scope string.
void dc_vars_get_global_string(void key)
{
    ...
    // Set function name for possible error trapping.
    dc_error_set_function("dc_vars_get_global_string(void key)");
...
// Set an global scope string.
int dc_vars_set_global_string(void key, int value)
{
    int is_key;     // Valid key flag.
    int is_string;  // Valid type flag.

    // Set function name for possible error trapping.
    dc_error_set_function("dc_vars_set_global_string(void key, void string)");
